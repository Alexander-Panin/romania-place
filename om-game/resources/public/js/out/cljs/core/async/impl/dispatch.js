...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13260 = 0;while(true){
var m_13261 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13261 == null))
{} else
{m_13261.call(null);
if((count_13260 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13262 = (count_13260 + 1);
count_13260 = G__13262;
continue;
}
} else
{}
