...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13225 = 0;while(true){
...
{var i_13232 = (self__.level + 1);while(true){
if((i_13232 <= (new_level + 1)))
{(update[i_13232] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13234 = 0;while(true){
if((i_13234 <= self__.level))
{var links_13235 = (update[i_13234]).forward;if(((links_13235[i_13234]) === x__$1))
{(links_13235[i_13234] = (x__$1.forward[i_13234]));
{
var G__13236 = (i_13234 + 1);
i_13234 = G__13236;
continue;
}
} else
{{
var G__13237 = (i_13234 + 1);
i_13234 = G__13237;
continue;
}
}
