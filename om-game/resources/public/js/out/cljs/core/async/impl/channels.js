...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13266 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13266 = (function (val,box,meta13267){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13266.cljs$lang$type = true;
cljs.core.async.impl.channels.t13266.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13266";
cljs.core.async.impl.channels.t13266.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t13266");
});
cljs.core.async.impl.channels.t13266.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13266.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13268){var self__ = this;
var _13268__$1 = this;return self__.meta13267;
});
cljs.core.async.impl.channels.t13266.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13268,meta13267__$1){var self__ = this;
var _13268__$1 = this;return (new cljs.core.async.impl.channels.t13266(self__.val,self__.box,meta13267__$1));
});
cljs.core.async.impl.channels.__GT_t13266 = (function __GT_t13266(val__$1,box__$1,meta13267){return (new cljs.core.async.impl.channels.t13266(val__$1,box__$1,meta13267));
});
}
return (new cljs.core.async.impl.channels.t13266(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13269 = self__.takes.pop();if((taker_13269 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13269))
{var take_cb_13270 = cljs.core.async.impl.protocols.commit.call(null,taker_13269);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13270,taker_13269){
return (function (){return take_cb_13270.call(null,null);
});})(take_cb_13270,taker_13269))
);
} else
{}
{
